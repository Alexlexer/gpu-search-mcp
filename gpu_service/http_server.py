...
<h2>Repository search</h2><input id="query" size="55" placeholder="Search code or describe what you need" onkeydown="if(event.key==='Enter')searchCode()"><button onclick="searchCode()">Search</button><pre id="results"></pre>
